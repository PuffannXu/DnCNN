...
def prepare_data(data_path, patch_size, stride, aug_times=1):
    ...
    if not os.path.exists(train_h5_path):
        ...
        print('train.h5 already exists, skipping training data preparation.')
    ...
    if not os.path.exists(val_h5_path):
        ...
        print('val.h5 already exists, skipping validation data preparation.')
